...
- 💼 Seeking **hybrid software roles in London** — systems, infrastructure, AI/ML
- 🎯 Core interests: **local-first systems**, **DeFi infrastructure**, **brain-inspired AI**, **trading systems**
- 🔭 Long-term: **high-performance systems**, **AI infrastructure**, **low-latency backends**

---

## 🧠 My Focus Areas

- 🤖 **AI & machine learning** — neuroevolution, RL, brain-inspired plasticity
- 🧵 **Compilers & GPU** — kernel fusion, e-graph rewriting, WGSL/PTX codegen
- ⚡ **Trading & fintech** — order book matching, wait-free structures, replay engines
- 🖼️ **Local-first applications** — embedded ML inference, CLIP semantic search
- 💹 **DeFi infrastructure** — AMM mechanics, cross-DEX arbitrage, on-chain analytics
- 🌐 **Network & concurrency** — HTTP stack, async runtimes, zero-copy I/O
- 🛠️ **Systems tooling** — TUIs, local-first CLIs, AI-augmented workflows
...
| [**Consilium**](https://github.com/Capataina/Consilium) | `Python`, `LangChain` | Provider-agnostic multi-LLM debate platform orchestrating structured multi-round discussions between heterogeneous language models via LangChain — Textual TUI, structured-state emission per round, agreement and disagreement tracking, and thesis-style final synthesis to transcripts |
...
| 🔧 Upstream | ✏️ Contribution | 📅 Outcome |
|------------|----------------|-----------|
| [**tinygrad**](https://github.com/tinygrad/tinygrad) | [PR #15453](https://github.com/tinygrad/tinygrad/pull/15453) — ONNX LSTM operator in `tinygrad/nn/onnx.py` covering forward, reverse, and bidirectional modes, optional initial hidden and cell states, and a shared activation helper spanning the full RNN activation set; regression tests against ONNX Runtime in `test/external/external_test_onnx_ops.py` | Closed on strict line-count policy, not on technical grounds |
| [**burn**](https://github.com/tracel-ai/burn) | [Issue #4312](https://github.com/tracel-ai/burn/issues/4312) — A-FINE image quality metric implementation (fidelity and naturalness evaluation in Rust) | Maintainer-confirmed implementation claim |

---

## 🧭 Currently Exploring

- 🧬 **Brain-inspired learning** — eligibility traces, dopamine-modulated updates, no backprop
- 💹 **DeFi market mechanics** — AMM math, cross-DEX arbitrage, Uniswap V3 LP simulation
- 🖼️ **Local-first ML applications** — embedded CLIP for privacy-preserving semantic search
- ⚡ **Lock-free systems** — atomic operations and wait-free structures for trading engines
- 🛠️ **Human-AI collaborative tooling** — scripts handle volume, Claude handles judgment
- 🤖 **AI paradigm comparison** — neuroevolution vs evolutionary algorithms vs RL, same tasks
- 🧵 **Compiler optimisation** — e-graph rewriting and kernel fusion for ML inference
- 🌐 **Network protocols** — TCP state machines, event loops, zero-copy I/O
